//substituindo o find() por filter()
...
const verifyAgeDrive2 = objPeople.filter((people) => (people.age < 18));
console.log((verifyAgeDrive2));
...
const removeRicardo = arrayMyStudents.filter((name) => (name !== 'Ricardo'));
