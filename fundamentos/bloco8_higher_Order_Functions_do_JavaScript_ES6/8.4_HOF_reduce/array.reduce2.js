...
const pegarMateria = (acc, materia) => {
  return (acc.nota < materia.nota) ? materia : acc 
};

const newArray = estudantes.map((student) => ({
  nome: student.nome,
  materia: student.materias.reduce(pegarMateria).name,
}))
