...
// 4 - Faça um novo for/in , mas agora mostre todos os valores das chaves do objeto. Valor esperado no console: {Margarida, Pato Donald, Namorada do personagem principal nos quadrinhos do Pato Donald, Sim}
for (i in info) {
  console.log(info[i])
}
...
for (let propriedade in info) {
  if (propriedade === 'recorrente' && info.recorrente === 'Sim' && info2.recorrente === 'Sim')
  {
